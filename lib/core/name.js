 ...
 * @param {module:core/doclet.Doclet} doclet
 */
exports.resolve = doclet => {
	...
	} else if (name && !memberof && doclet.meta.code && doclet.meta.code.funcscope) { // member of a var in an outer scope?
 ...
 * @param {Object<string, module:core/doclet.Doclet>} doclets - The doclets to attach to a tree.
