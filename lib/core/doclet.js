...
const Syntax = require('core/syntax').Syntax;
const Tag = require('core/tag').Tag;
...
// TODO: set this elsewhere (maybe core/astnode.getInfo)
function codeToKind(code) {
	const isFunction = astnode.isFunction;
	let kind = 'member';
 ...
 *
 * @private
 * @param {module:tag/dictionary.Dictionary} dict - The new tag dictionary.
 */
exports._replaceDictionary = function _replaceDictionary(dict) {
	dictionary = dict;
	require('core/tag')._replaceDictionary(dict);
	require('utils/templateHelper')._replaceDictionary(dict);
};
 ...
 *
 * @private
 * @param {module:core/doclet.Doclet} doclet The doclet to check for a filepath.
 ...
 *
 * @private
 * @param {module:core/doclet.Doclet} primary - The primary doclet.
 * @param {module:core/doclet.Doclet} secondary - The secondary doclet.
 * @param {module:core/doclet.Doclet} target - The doclet to which properties will be copied.
 ...
 *
 * @alias module:core/doclet.Doclet
 */
class Doclet {
	/**
	 * Create a doclet.
	 ...
	 * {@link module:core/name.SCOPE.NAMES}.
	 *
	 * @param {module:core/name.SCOPE.NAMES} scope - The scope for the doclet relative to the
	 * symbol's parent.
 ...
 *
 * @param {module:core/doclet.Doclet} primary - The doclet whose properties will be used.
 * @param {module:core/doclet.Doclet} secondary - The doclet to use as a fallback for properties
