...
const jsdoc = {
	name: require('core/name'),
	tag: {
		inline: require('tag/inline')
	},
	util: {
 ...
 * @return {module:tag/type.TypeExpressionInfo} The type expression and updated tag text.
 */
 ...
 *
 * @private
 * @param {module:tag/type.TagInfo} tagInfo - Information contained in the tag.
 * @return {module:tag/type.TagInfo} Updated information from the tag.
 */
 ...
 * @return {module:tag/type.TagInfo} Information obtained from the tag.
