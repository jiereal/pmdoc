 ...
 * at level `{@link module:utils/logger.LEVELS.ERROR}` or above are logged; all other messages
 * are ignored.
 *
 ...
 * {@link module:utils/logger.LEVELS.ERROR}.
 *
 * @alias module:utils/logger.LEVELS
 * @enum
 * @type {number}
 */
const LEVELS = logger.LEVELS = {
	 ...
	 *
	 * @alias module:utils/logger.LEVELS.SILENT
	 */
	SILENT: 0,
	/**
	 * Log fatal errors that prevent JSDoc from running.
	 *
	 * @alias module:utils/logger.LEVELS.FATAL
	 */
	FATAL: 10,
	/**
	 * Log all errors, including errors from which JSDoc can recover.
	 *
	 * @alias module:utils/logger.LEVELS.ERROR
	 */
	ERROR: 20,
	/**
	 ...
	 * + Errors
	 *
	 * @alias module:utils/logger.LEVELS.WARN
	 */
	WARN: 30,
	/**
	 * Log the following messages:
	 ...
	 * + Errors
	 *
	 * @alias module:utils/logger.LEVELS.INFO
	 */
	INFO: 40,
	/**
	 * Log the following messages:
	 ...
	 * + Errors
	 *
	 * @alias module:utils/logger.LEVELS.DEBUG
	 */
	DEBUG: 50,
	/**
	 * Log all messages.
	 *
	 * @alias module:utils/logger.LEVELS.VERBOSE
	 */
	VERBOSE: 1000
};
...
/**
 * Log a message at log level {@link module:utils/logger.LEVELS.DEBUG}.
 *
 * @alias module:utils/logger.debug
...
/**
 * Print a string at log level {@link module:utils/logger.LEVELS.DEBUG}. The string is not
 * terminated by a newline.
 *
 * @alias module:utils/logger.printDebug
 * @param {string} message - The message to log.
 * @param {...*=} values - The values that will replace the message's placeholders.
 */
logger.printDebug = wrapLogFunction('debug', printToStdout);
/**
 * Log a message at log level {@link module:utils/logger.LEVELS.ERROR}.
 *
 * @alias module:utils/logger.error
 * @param {string} message - The message to log.
 * @param {...*=} values - The values that will replace the message's placeholders.
 */
logger.error = wrapLogFunction('error', console.error);
/**
 * Log a message at log level {@link module:utils/logger.LEVELS.FATAL}.
 *
 * @alias module:utils/logger.fatal
 * @param {string} message - The message to log.
 * @param {...*=} values - The values that will replace the message's placeholders.
 */
logger.fatal = wrapLogFunction('fatal', console.error);
/**
 * Log a message at log level {@link module:utils/logger.LEVELS.INFO}.
 *
 * @alias module:utils/logger.info
 * @param {string} message - The message to log.
 * @param {...*=} values - The values that will replace the message's placeholders.
 */
logger.info = wrapLogFunction('info', console.info);
/**
 * Print a string at log level {@link module:utils/logger.LEVELS.INFO}. The string is not
 * terminated by a newline.
 *
 * @alias module:utils/logger.printInfo
 * @param {string} message - The message to log.
 * @param {...*=} values - The values that will replace the message's placeholders.
 */
logger.printInfo = wrapLogFunction('info', printToStdout);
/**
 * Log a message at log level {@link module:utils/logger.LEVELS.VERBOSE}.
 *
 * @alias module:utils/logger.verbose
 * @param {string} message - The message to log.
 * @param {...*=} values - The values that will replace the message's placeholders.
 */
logger.verbose = wrapLogFunction('verbose', console.info);
/**
 * Print a string at log level {@link module:utils/logger.LEVELS.VERBOSE}. The string is not
 * terminated by a newline.
 *
 * @alias module:utils/logger.printVerbose
 * @param {string} message - The message to log.
 * @param {...*=} values - The values that will replace the message's placeholders.
 */
logger.printVerbose = wrapLogFunction('verbose', printToStdout);
/**
 * Log a message at log level {@link module:utils/logger.LEVELS.WARN}.
 *
 * @alias module:utils/logger.warn
 * @param {string} message - The message to log.
 * @param {...*=} values - The values that will replace the message's placeholders.
 */
 ...
 * Set the log level.
 *
 * @alias module:utils/logger.setLevel
 * @param {module:utils/logger.LEVELS} level - The log level to use.
 */
 ...
 *
 * @alias module:utils/logger.getLevel
 * @return {module:utils/logger.LEVELS} The current log level.
 */
